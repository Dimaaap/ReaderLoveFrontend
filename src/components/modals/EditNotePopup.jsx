...
export const EditNotePopup = ({ note, menuCloser, deleter, onShare }) => {

  const { setEditBookNoteModalOpen } = useEditBookNoteModalState();
  ...
  return (
    <div className="absolute top-14 right-2 bg-[#0D0B0C] text-white rounded-lg flex flex-col gap-2">
        ...
        duration-200" onClick={ () => {
            setEditBookNoteModalOpen(true, note)
            menuCloser(false)
            } }>
