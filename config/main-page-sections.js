export const sections = [
    {
        "imageSrc": "/newdash.png",
        "header": "Почніть вимірювати ⏱",
    ...
    {
        "imageSrc": "/second-section.png",
        "header": "Читайте регулярно ⛵",
        "textFirst": "Тепер ви бачите коли читаєте.",
        "textSecond": "Це круто — читати хоча б хвилину на день :)",
        "backgroundColor": "#FFCC90"
    },
    {
        "imageSrc": "/third-section.png",
        "header": "Конспектуйте ⛲",
        "textFirst": "Прочитане забувається?",
        "textSecond": "Нотатки, цитати, хороші ідеї або summary тепер завжди в застосунку Rork."
    },
    {
        "imageSrc": "/fourth-section.png",
        "header": "Надихайтеся ✈️",
    ...
    {
        "imageSrc": "/fifth-section.png",
        "header": "Колекціонуйте ✨",
